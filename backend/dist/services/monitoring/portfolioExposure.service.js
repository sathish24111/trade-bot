...
exports.portfolioExposureService = exports.PortfolioExposureService = void 0;
...
class PortfolioExposureService {
    ...
    async calculatePortfolioExposure(params) {
        ...
        try {
            await database_1.pool.query(`INSERT INTO portfolio_exposure_snapshots 
...
exports.portfolioExposureService = new PortfolioExposureService();
