...
class PortfolioWhatIfService {
    ...
    async simulateWhatIf(params) {
        ...
        await database_1.pool.query(`INSERT INTO portfolio_what_if_runs 
    ...
    async listRuns(limit = 20) {
        const [rows] = await database_1.pool.query(`SELECT * FROM portfolio_what_if_runs ORDER BY created_at DESC LIMIT ?`, [limit]);
        return rows.map(r => ({
...
exports.PortfolioWhatIfService = PortfolioWhatIfService;
exports.portfolioWhatIfService = new PortfolioWhatIfService();
