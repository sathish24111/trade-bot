...
exports.parameterStabilityService = exports.ParameterStabilityService = void 0;
...
class ParameterStabilityService {
    /**
    ...
    async analyzeParameterStability(params) {
        ...
        let sampleQuality = 'MODERATE';
        if (totalTrades < 30) {
            sampleQuality = 'LIMITED';
            if (totalTrades < 10)
                region = 'INSUFFICIENT_DATA';
        }
    ...
    async persistRun(res) {
        try {
            await database_1.pool.query(`INSERT INTO parameter_stability_runs (strategy_id, parameter_key, baseline_value, stability_score, region, cliff_count, tested_variations, sample_quality)
         VALUES (?, ?, ?, ?, ?, ?, ?, ?)`, [
                res.strategyId,
                res.parameterKey,
...
exports.ParameterStabilityService = ParameterStabilityService;
exports.parameterStabilityService = new ParameterStabilityService();
