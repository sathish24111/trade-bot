...
exports.paperReplayService = exports.PaperReplayService = void 0;
...
class PaperReplayService {
    ...
    async initReplay(params) {
        ...
        const candles = await market_service_1.marketService.getCandles(asset, timeframe, candlesCount);
    ...
    stepNext(sessionId) {
        ...
        if (session.state.currentIndex < session.candles.length - 1) {
            ...
            const stratResult = strategy_service_1.strategyEngine.evaluateFromCandles('EMA_RSI', visibleCandles);
...
exports.PaperReplayService = PaperReplayService;
exports.paperReplayService = new PaperReplayService();
