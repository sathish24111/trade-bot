...
const ROBUSTNESS_DISCLAIMER =
  'Robustness analysis evaluates empirical consistency across historical parameter spaces, regimes, and partitions. It does not select or declare a single guaranteed winner or predict future profitability.';
...
export class RobustnessService {
  ...
  analyzeRobustness(params: {
    ...
    optimizationResults?: OptimizationCombinationResult[];
    ...
    let parameterStabilityRating: 'HIGH' | 'MODERATE' | 'LOW' = 'MODERATE';
    ...
    let oosConsistencyRatio: number | null = null;
    ...
    let drawdownStabilityRating: 'STABLE' | 'MODERATE' | 'UNSTABLE' = 'STABLE';
    ...
    let regimeAdaptabilityRating: 'ALL_REGIMES' | 'REGIME_DEPENDENT' | 'VULNERABLE' = 'ALL_REGIMES';
...
export const robustnessService = new RobustnessService();
