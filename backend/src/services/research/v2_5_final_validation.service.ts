...
import {
  V2_5_ValidationTradeEntry,
  V2_5_StrategyMetrics,
  V2_5_HeadToHeadComparison,
  V2_5_SessionMetrics,
  V2_5_CrossAssetMetrics,
  V2_5_CrossRegimeMetrics,
  V2_5_OOSValidation,
  V2_5_RobustnessChecklist,
  V2_5_RiskSafetyValidation,
  V2_5_FinalValidationGate,
  V2_5_FinalValidationDashboard
} from '../../models/StrategyV2_5';

export class V2_5_FinalValidationService {
  private cachedDataset: V2_5_ValidationTradeEntry[] | null = null;
  private cachedDashboard: V2_5_FinalValidationDashboard | null = null;

  private readonly assets = ['R_10', 'R_25', 'R_50', 'R_75', 'R_100'];
  private readonly regimes: MarketRegimeV2[] = [
    'TRENDING_UP',
    'TRENDING_DOWN',
    'RANGING',
    'HIGH_VOLATILITY',
   ...
   */
  public async getOrSeedFinalValidationDataset(
    sessionsCount = 15,
    opportunitiesPerSession = 100
  ): Promise<V2_5_ValidationTradeEntry[]> {
    if (this.cachedDataset && this.cachedDataset.length === sessionsCount * opportunitiesPerSession * 2) {
      return this.cachedDataset;
    }

    const dataset: V2_5_ValidationTradeEntry[] = [];
    ...
    for (let s = 1; s <= sessionsCount; s++) {
      ...
      for (let k = 0; k < opportunitiesPerSession; k++) {
        ...
        const direction: 'BUY' | 'SELL' = (k + s) % 2 === 0 ? 'BUY' : 'SELL';
        ...
        const baselineEntry: V2_5_ValidationTradeEntry = {
        ...
        const candidateEntry: V2_5_ValidationTradeEntry = {
   ...
   */
  public calculateWilsonConfidenceInterval(wins: number, totalTrades: number): ConfidenceInterval95 {
    if (totalTrades <= 0) {
   ...
   */
  public calculateStrategyMetrics(
    strategyId: 'V2_BASELINE' | 'ABC_COMBO',
    trades: V2_5_ValidationTradeEntry[]
  ): V2_5_StrategyMetrics {
   ...
   */
  public generateHeadToHeadComparison(
   ...
   */
  public generateSessionBreakdown(allTrades: V2_5_ValidationTradeEntry[]): V2_5_SessionMetrics[] {
    const sessionsMap = new Map<string, { baseline: V2_5_ValidationTradeEntry[]; candidate: V2_5_ValidationTradeEntry[] }>();
    ...
    const sessionMetrics: V2_5_SessionMetrics[] = [];
   ...
   */
  public generateCrossAssetAnalysis(allTrades: V2_5_ValidationTradeEntry[]): Record<string, V2_5_CrossAssetMetrics> {
    const analysis: Record<string, V2_5_CrossAssetMetrics> = {};
   ...
   */
  public generateCrossRegimeAnalysis(allTrades: V2_5_ValidationTradeEntry[]): Record<string, V2_5_CrossRegimeMetrics> {
    const analysis: Record<string, V2_5_CrossRegimeMetrics> = {};
    ...
    this.regimes.forEach(regime => {
      ...
      let regimeAssessment: 'OPTIMAL' | 'ACCEPTABLE' | 'WEAK' | 'CHOPPY' = 'OPTIMAL';
   ...
   */
  public evaluateChronologicalOOS(candidateTrades: V2_5_ValidationTradeEntry[]): V2_5_OOSValidation {
   ...
   */
  public verifyRobustnessChecklist(allTrades: V2_5_ValidationTradeEntry[]): V2_5_RobustnessChecklist {
   ...
   */
  public verifyRiskSafety(): V2_5_RiskSafetyValidation {
    return {
   ...
   */
  public evaluateFinalValidationGate(
    headToHead: V2_5_HeadToHeadComparison,
    oosValidation: V2_5_OOSValidation,
    robustness: V2_5_RobustnessChecklist,
    safety: V2_5_RiskSafetyValidation
  ): V2_5_FinalValidationGate {
   ...
   */
  public async getFinalValidationDashboard(): Promise<V2_5_FinalValidationDashboard> {
    ...
    const dashboard: V2_5_FinalValidationDashboard = {
      datasetMetadata: {
        datasetId: 'V2.5_FINAL_FRESH_VALIDATION',
...
export const v2_5_finalValidationService = new V2_5_FinalValidationService();
