import { Candle, MarketAsset, MarketQuote, TechnicalIndicators } from '../../models/MarketData';
import { IMarketDataProvider } from './MarketDataProvider.interface';
import { indicatorService } from '../indicator.service';

interface MockAssetDef {
  symbol: string;
  name: string;
  basePrice: number;
  variance: number;
...
export class MockMarketDataProvider implements IMarketDataProvider {
  ...
  private defaultDefinitions: MockAssetDef[] = [
  ...
  private generateCandles(basePrice: number, variance: number, count: number): Candle[] {
